...
class PolicyResearchState:
    ...
    company_seeds: list[dict[str, Any]] = field(default_factory=list)
    company_seed_audit: list[dict[str, Any]] = field(default_factory=list)
    company_discovery_audit: list[dict[str, Any]] = field(default_factory=list)
    company_identity_audit: list[dict[str, Any]] = field(default_factory=list)
    company_evidence_bundles: list[dict[str, Any]] = field(default_factory=list)
